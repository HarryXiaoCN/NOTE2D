...
Er:
    noteSaveCheck_ContentCheck = True
End Function
Public Function NoteFileWrite_203_Coding(ByRef nodeObj() As 节点, ByRef nodeObjSum As Long, _
ByRef lineObj() As 连接, ByRef lineObjSum As Long)
    ...
    Next
    lineSum = j - nodeSum - 1
    ntx(0) = VERSIONID & LINEBREAK & nodeSum & LINEBREAK & lineSum & LINEBREAK & magnification & LINEBREAK & Note.节点归整.Checked & LINEBREAK & NoteFileWrite_203_Coding_DIC
    NoteFileWrite_203_Coding = ntx
End Function
Public Function NoteFileWrite_203_Coding_DIC() As String
    Dim i As Long
    
    For i = 0 To nodeSelectKeyDic.Count - 1
        NoteFileWrite_203_Coding_DIC = NoteFileWrite_203_Coding_DIC & nodeSelectKeyDic.Keys(i) & VALUEBREAK & nodeSelectKeyDic.Items(i) & KEYBREAK
    Next
        
    If Len(NoteFileWrite_203_Coding_DIC) > 0 Then
        NoteFileWrite_203_Coding_DIC = Mid(NoteFileWrite_203_Coding_DIC, 1, Len(NoteFileWrite_203_Coding_DIC) - 1)
    End If
    NoteFileWrite_203_Coding_DIC = NoteFileWrite_203_Coding_DIC & DICBREAK
    
    For i = 0 To lineSelectKeyDic.Count - 1
        NoteFileWrite_203_Coding_DIC = NoteFileWrite_203_Coding_DIC & lineSelectKeyDic.Keys(i) & VALUEBREAK & lineSelectKeyDic.Items(i) & KEYBREAK
    Next
    If Len(NoteFileWrite_203_Coding_DIC) > 0 Then
        NoteFileWrite_203_Coding_DIC = Mid(NoteFileWrite_203_Coding_DIC, 1, Len(NoteFileWrite_203_Coding_DIC) - 1)
    End If
